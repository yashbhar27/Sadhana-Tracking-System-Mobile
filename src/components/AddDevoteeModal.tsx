...
interface AddDevoteeModalProps {
  isOpen: boolean;
  onClose: () => void;
}

const AddDevoteeModal = ({ isOpen, onClose }: AddDevoteeModalProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const success = await addDevotee(name, isResident);
      ...
      <div className="modal-content w-full max-w-md" onClick={e => e.stopPropagation()}>
        <div className="modal-header flex justify-between items-center">
          <h2 className="text-xl font-semibold text-gray-800">
            {showPasswordScreen ? 'Admin Authentication' : 'Add New Devotee'}
          </h2>
...
export default AddDevoteeModal;